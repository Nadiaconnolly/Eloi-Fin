class Game {
    constructor(images, sounds){
        ...
        this.startButton = createButton('do not')
        this.startButton.mousePressed(this.init)
        this.startScreen = new Overlay(`wanna start?`, 'it is just what you think', this.startButton)
        this.gameOverScreen = new Overlay('you are not good enough!', 're-enter?', this.startButton)
        this.died = false 
    }
